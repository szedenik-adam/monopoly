...
string generate_key(const string &key) {
	...
	char* shatest = "dGhlIHNhbXBsZSBub25jZQ==258EAFA5-E914-47DA-95CA-C5AB0DC85B11";
	unsigned char out[40];
	SHA1(shatest, strlen(shatest), (char*)out);
	string rrr = base64_encode(out, 20);
	if(!strcmp("s3pPLMBiTxaQ9kYGzzhZRbK+xOo=",rrr.c_str())) printf("[sha1 and base64 passed\n]");
	// s3pPLMBiTxaQ9kYGzzhZRbK+xOo=

	//sha-1
	string tmp = key
		+ "258EAFA5-E914-47DA-95CA-C5AB0DC85B11";
	//tmp.append("258EAFA5-E914-47DA-95CA-C5AB0DC85B11");
	unsigned char md[40];// = {0};
	md[0]=0;
	SHA1((const char*)tmp.c_str(), tmp.length(), (char*)md);
